function Daily_Adjust_Close_Larger_Equal=Data_Cleaning_Larger_Equal(Daily_Adjust_Close,Daily_Adjust_Close_Larger_Set)
...
Daily_Adjust_Close_Larger_Equal=[Daily_Adjust_Close(:,1:end-1) e];
